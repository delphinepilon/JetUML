...
public final class ImplicitParameterNode extends NamedNode
{
	...
	public boolean equals(Object pObject)
	{
		...
		{
			ImplicitParameterNode implicitParameterNode = (ImplicitParameterNode)pObject;
			List<Node> children = getChildren();
			if (children.size() != implicitParameterNode.getChildren().size())
			{
				return false;
			}
			for (Node child : children)
			{
				if (!implicitParameterNode.getChildren().contains(child))
				{
					return false;
				}
			}
