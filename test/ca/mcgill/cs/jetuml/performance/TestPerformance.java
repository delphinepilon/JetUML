package ca.mcgill.cs.jetuml.performance;
 ...
 public class TestPerformance 
 {
 	...
 	private static void testDrawDiagram(int pNumberOfDrawCalls) throws IOException 
 	{
 		...
 		for (int i = 0; i < NUMBER_OF_TRIALS+1; i++)
 		{
 			...
 			for (int j = 0; j < pNumberOfDrawCalls; j++)
 			{
 		...
 		System.out.println("Call DiagramViewer.draw(diagram) " + pNumberOfDrawCalls + " time(s) : ");
 		System.out.println("Average Duration (ms) over " + NUMBER_OF_TRIALS + " trials : " + avgExecutionTime + "\n");
 	}
 } 